    ...
    try:
        while True:
            ...
            if market_weekend_closed(now):
                ...
                # Full market-closed silence: education remains available in code,
                # but the live worker must not publish anything automatically
                # while the XAU weekend guard is active.
