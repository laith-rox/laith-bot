...
72 اختبارًا ناجحًا: 10 حالات جديدة لتصحيح صاعد/هابط، صعود يقارب 30$ ثم شمعة حمراء صغيرة مع مؤشرات ساعة متأخرة، منع الدخول المضاد لسياق الاتجاه، تتابع القمم والقيعان وفجواتها، اشتراط إغلاقين بدل ذيول الشموع لتأكيد كسر النطاق، عودة السعر داخله، اختلاف ميل متوسط الساعة، حجب الإشارة الكاملة عند تعارض السياق، وتمييز تحذير الضغط عن الكسر المؤكد. بقيت اختبارات الوقف والأهداف والأخبار والإيقاف والإرسال ناجحة.

هذه اختبارات قواعد على بيانات صناعية، وليست إعادة بناء لصفقات المستخدم اليوم أو برهانًا على تحسين الربحية. لم تُستخرج أسعار حساب JustMarkets ولم تُحسب نسبة نجاح جديدة.
