...
class GlobalDataTests(unittest.TestCase):
    ...
    def test_macro_score_direction_is_symmetric(self):
        ...
        self.assertEqual(macro_alignment("BUY", {"gold_macro_score": score}), "STRONG_ALIGN")
        self.assertEqual(macro_alignment("SELL", {"gold_macro_score": score}), "STRONG_CONFLICT")
...
class GateTests(unittest.TestCase):
    ...
    def test_only_strong_macro_conflict_vetoes(self):
        strong = {"gold_macro_score": -6}
        mild = {"gold_macro_score": -2}
    ...
    def test_core_session_normal_vol_keeps_strict_signal(self):
        ...
        with patch("v3_research.analyze", return_value=base), \
            ...
            result = analyze_v3([], datetime(2026, 9, 16, 14, tzinfo=UTC), macro={"gold_macro_score": 2})
